                ...
                for msg in reversed(messages):
                    ...
                    if 'photos' in msg:
                        ...
                        for photo in msg['photos']:
                            # Path traversal protection: validate path is within export_path
                            src_photo = os.path.abspath(os.path.join(export_path, photo['uri']))
                            export_path_abs = os.path.abspath(export_path) + os.sep
                            if not src_photo.startswith(export_path_abs):
                    ...
                    if 'audio_files' in msg:
                        ...
                        for audio in msg['audio_files']:
                            ...
                            export_path_abs = os.path.abspath(export_path) + os.sep
                            if not src_audio.startswith(export_path_abs):
