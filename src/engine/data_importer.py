        ...
        for chat_folder in os.listdir(inbox_path):
            ...
            for m_file in message_files:
                ...
                for msg in reversed(messages):
                    ...
                    # Buffer messages for batched indexing (significant performance boost)
                    message_buffer.append((chat_name, quarter_id, content))
                    if len(message_buffer) >= batch_size:
                        rag_engine.add_messages_batch(message_buffer)
                        message_buffer = []
