        ...
        try:
            ...
            for thread in threads:
                ...
                for msg in reversed(messages):
                    ...
                    thread_messages_to_index.append((chat_name, quarter_id, content))
                ...
                if thread_messages_to_index:
                    rag_engine.add_messages_batch(thread_messages_to_index)
