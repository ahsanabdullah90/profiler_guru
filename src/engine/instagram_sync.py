        ...
        try:
            ...
            for thread in threads:
                ...
                for msg in reversed(messages):
                    ...
                    # Batch messages for indexing at thread level
                    thread_indexing_batch.append((chat_name, quarter_id, content))
                ...
                if thread_indexing_batch:
                    rag_engine.add_messages_batch(thread_indexing_batch)
